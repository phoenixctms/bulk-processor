package CTSMS::BulkProcessor::SqlConnectors::OracleDB;
use strict;
...
use CTSMS::BulkProcessor::Logging qw(
    ...
    tabletruncated
    tabledropped);
use CTSMS::BulkProcessor::LogError qw(dberror dbwarn fieldnamesdiffer);

use DBI;
use DBD::Oracle 1.21;

use CTSMS::BulkProcessor::Array qw(contains arrayeq setcontains);
