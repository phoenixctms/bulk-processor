package CTSMS::BulkProcessor::RestRequests::ctsms::shared::SelectionSetService::AddressType;
use strict;
...
my $get_item_path_query = sub {
    my ($id) = @_;
    return 'selectionset/addresstype/' . get_query_string({ typeId => $id });
};
my $get_proband_item_path_query = sub {
    ...
    return 'selectionset/availableprobandaddresstypes/' . get_query_string(\%params);
};
my $get_staff_item_path_query = sub {
    return 'selectionset/availablestaffaddresstypes/';
};
