...
my $get_complete_path_query = sub {
    my ($zip_code_prefix, $country_name_infix, $city_name_infix, $limit) = @_;
    my %params = ();
...
sub complete_zip_code {
    ...
    my ($zip_code_prefix, $country_name_infix, $city_name_infix, $limit, $load_recursive,$restapi,$headers) = @_;
    my $api = _get_api($restapi,$default_restapi);
    return builditems_fromrows($api->get(&$get_complete_path_query($zip_code_prefix, $country_name_infix, $city_name_infix, $limit),$headers),$load_recursive,$restapi);
