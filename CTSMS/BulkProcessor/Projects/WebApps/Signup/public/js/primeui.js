 ...
 (function (factory) {
    ...
    $.widget("primeui.puiautocomplete", {
        ...
        disable: function () {
            ...
            this.dropdown.removeClass('ui-state-focus ui-state-hover');
            this._disableMouseEffects();
        },
        
        _disableMouseEffects: function () {
            this.dropdown.off('mouseenter.puiautocomplete mouseleave.puiautocomplete mousedown.puiautocomplete mouseup.puiautocomplete focus.puiautocomplete blur.puiautocomplete keydown.puiautocomplete keyup.puiautocomplete');
        },
 ...
 (function (factory) {
    ...
    $.widget("primeui.puicarousel", {
       ...
       options: {
            ...
            if(this.data) {
                for(var i = 0; i < data.length; i++) {
                    ...
                    if($.type(itemContent) === 'string') {
                        ...
                        this._initItemContent(itemContent);
                    }
                }
            }
        ...
        _initItemContent: function(obj) {
            if(this.options.initContent) {
                return this.options.initContent.call(this, obj);
            }
        },
        ...
        _bindEvents: function() {
            ...
            this.prevNav.on('click.puicarousel', function() {
                ...
                $this._trigger('navigate', null, {'page':($this.totalPages - 1)});
            });
            ...
            this.nextNav.on('click.puicarousel', function() {
                ...
                $this._trigger('navigate', null, {'page':0});
            });
                ...
                this.element.swipe({
                    swipe:function(event, direction) {
                        if(direction === 'left') {
                            ...
                            $this._trigger('navigate', null, {'page':($this.page + 1)});
                        }
            ...
            if(this.pageLinks.length) {
                this.pageLinks.on('click.puicarousel', function(e) {
                    ...
                    e.preventDefault();
                    $this._trigger('navigate', null, {'page':$(this).index()});
                });
            }

            this.header.children('select').on('change.puicarousel', function() {
                $this.setPage(parseInt($(this).val()) - 1);
                $this._trigger('navigate', null, {'page':(parseInt($(this).val()) - 1)});
            });
    ...
    $.widget("primeui.puidatagrid", {
        ...
        paginate: function(callback) {
            if(this.options.lazy) {
                return this.options.datasource.call(this, this._onLazyLoad, this._createStateMeta(), callback);
            }
            else {
               this._renderData();
            }
        ...
        _getInitialFirst: function() {
            if(this.options.paginator)
                return this._getRows() * (this.paginator ? this.paginator.puipaginator('option', 'page') : (this.options.paginator.page >= 0 ? this.options.paginator.page : 0)); 
            else
                return 0;
        },
        ...
        _initPaginator: function() {
            var $this = this;
            if(this.options.paginator) {
                this.options.paginator.paginate = function(event, state, callback) {
                    return $this.paginate(callback);
                };
        ...
        _initDatasource: function() {
            if($.isArray(this.options.datasource)) {
                ...
                if($.type(this.options.datasource) === 'function') {
                    if(this.options.lazy)
                        this.options.datasource.call(this, this._onDataInit, {first: this._getInitialFirst(), rows: this._getRows()}); //0
                    else
        ...
        _updateDatasource: function(datasource) {
            ...
            if($.isArray(this.options.datasource)) {
                ...
                if(this.options.lazy)
                    this.options.datasource.call(this, this._onDataUpdate, {first: this._getInitialFirst(), rows: this._getRows()}); //0
                else
 ...
 */
 (function (factory) {
    ...
    $.widget("primeui.puidatatable", {
        ...
        paginate: function(callback) {
            if(this.options.lazy) {
                this.options.datasource.call(this, this._onLazyLoad, this._createStateMeta(), callback);
            }
            else {
               this._renderData();
            }
 ...
 (function (factory) {
    ...
    $.widget("primeui.puitimepicker", {
        ...
        _create: function() {
            ...
            input.fgtimepicker(this.options);
        },
        
        _destroy: function() {
            this.element.removeClass('ui-inputtext ui-widget ui-state-default ui-state-disabled ui-state-hover ui-state-focus ui-corner-all');
            this._disableMouseEffects();
            $.fgtimepicker._destroyTimepicker(this.element);
        },
        ...
        setTime: function (time) {
            this.element.fgtimepicker('setTime',time);
        },
        getTime: function () {
            return this.element.fgtimepicker('getTimeAsDate');
        },        
    ...
    $.widget("primeui.puidatepicker", {
        ...
        _create: function() {
            ...
            if (this.options.altField) {
                //alert(document.getElementById(this.altfield).value);
                this.setDate($(this.options.altField).val(),1);
                //this.setDate(document.getElementById(this.altfield).value,1);
            }
        },
        ...
        _destroy: function() {
            this.element.removeClass('ui-inputtext ui-widget ui-state-default ui-state-disabled ui-state-hover ui-state-focus ui-corner-all');
            this._disableMouseEffects();
            $.datepicker._destroyDatepicker(this.element);
        },
        ...
        setDate: function (date, alt) {
            this.element.datepicker('setDate',date,alt);
        },
        getDate: function () {
 ...
 (function (factory) {
    ...
    $.widget("primeui.puimenubar", $.primeui.puitieredmenu, {
        ...
        _create: function() {
            ...
            if(!this.options.enhanced) {
                this.element.parent().removeClass('ui-tieredmenu').addClass('ui-menubar ui-widget-header');
            }
        },
    ...
    $.widget("primeui.puipaginator", {
        ...
        setPage: function(p, silent) {
            ...
            if(p >= 0 && p < pc) {
                ...
                if(!silent) {
                    var $this = this;
                    this._trigger('paginate', null, [ newState, function(prevent) {
                        if (prevent) {
                            $this.options.page = oldPage;
                        } else {
        ...
        _spin: function(step) {
            ...
            if ($.trim(newValue) == '') {
                ...
                if(this.options.precision) {
                    newValue = parseFloat(this._toFixed(newValue + step, this.options.precision));
                }
                else {
                    newValue = parseInt(newValue + step, 10);
                }
            }
