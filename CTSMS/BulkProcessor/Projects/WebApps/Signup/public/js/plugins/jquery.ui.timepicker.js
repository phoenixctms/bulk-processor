...
(function ($) {
    ...
    function FGTimepicker() {
        ...
        this.regional.de = { // Default regional settings
            ...
            minuteText: 'Minute',       // Display text for minutes link
            amPmText: ['AM', 'PM'],     // Display text for AM PM
            closeButtonText: 'Schließen',        // Text for the confirmation button (ok button)
            nowButtonText: 'Akt. Uhrzeit',           // Text for the now button
            deselectButtonText: 'Entmarkieren'  // Text for the deselect button
        };
...
*/
        ...
        */
        ...
        _getTimeAsDateTimepicker: function(input) {
            ...
            return new Date(1970, 0, 1, inst.hours, inst.minutes, 0);
        },
