...
(function(FieldCalculation) {
	...
	function _getInputFieldVariable(variableName, index) {
		...
		//} else if (jQuery.isArray(variableName)) {
...
//		}
	...
	//
	//	_inputFieldOnChange(variableName, index, widget.getValue());
	//
	//}
	...
	function floatOnChange(value) {
		...
		if (!silent) _inputFieldOnChange(value.inquiry.jsVariableName, value.index, getDecimalVal(value.inquiry.id));

	}	

	//function dateOnChange(variableName, index, widget, outputId) {
	//
	//	_inputFieldOnChange(variableName, index, widget.getDate());
	//
	//}
	...
	//
	//	_inputFieldOnChange(variableName, index, widget.getTime());
	//
	//}
	...
	function timestampOnChange(value) {
		...
		if (!silent) _inputFieldOnChange(value.inquiry.jsVariableName, value.index, getDateTimePickerVal(value.inquiry.id));
	...
	function floatApplyCalculatedValue(value) {
		silent = true;
		setDecimalVal(value.inquiry.id, _inputFieldApplyCalculatedValue(value.inquiry.jsVariableName, value.index));
		silent = false;
	}	
	...
	function dateApplyCalculatedValue(value) {
		silent = true;
		setDatePickerVal(value.inquiry.id, _inputFieldApplyCalculatedValue(value.inquiry.jsVariableName, value.index));
		silent = false;
	}
	...
	function timeApplyCalculatedValue(value) {
		silent = true;
		setTimePickerVal(value.inquiry.id, _inputFieldApplyCalculatedValue(value.inquiry.jsVariableName, value.index));
		silent = false;
	}
	...
	function timestampApplyCalculatedValue(value) {
		silent = true;
		setDateTimePickerVal(value.inquiry.id, _inputFieldApplyCalculatedValue(value.inquiry.jsVariableName, value.index));
		silent = false;
	}	
