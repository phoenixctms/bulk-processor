...
$.extend(Datepicker.prototype, {
	 ...
	 */
	_setDateDatepicker: function(target, date, alt) {
		var inst = this._getInst(target);
		if (inst) {
			this._setDate(inst, date, null, alt);
			this._updateDatepicker(inst);
			this._updateAlternate(inst);
		}
	},
	...
	_determineDate: function(inst, date, defaultDate, alt) {
		var offsetNumeric = function(offset) {
			...
			offsetString = function(offset) {
				try {
					return $.datepicker.parseDate($.datepicker._get(inst, alt ? "altFormat" : "dateFormat"),
	...
	_setDate: function(inst, date, noChange, alt) {
		var clear = !date,
			origMonth = inst.selectedMonth,
			origYear = inst.selectedYear,
			newDate = this._restrictMinMax(inst, this._determineDate(inst, date, new Date(), alt));
