perl process.pl --config=config.debug.cfg --settings=settings.debug.cfg --task=cleanup_all --force

perl process.pl --config=config.debug.cfg --settings=settings.debug.cfg --task=create_ecrfstatustype_diagram
perl process.pl --config=config.debug.cfg --settings=settings.debug.cfg --task=create_courseparticipationstatustype_diagrams
perl process.pl --config=config.debug.cfg --settings=settings.debug.cfg --task=create_privacyconsentstatustype_diagram
...
perl process.pl --config=config_de.debug.cfg --settings=settings_de.debug.cfg --task=create_privacyconsentstatustype_diagram
